...
tryFunction <- function( expr, place, log = logFile, ID = userID, dir = userDir ){
  ...
  if( class(res) == "try-error" ){
    ...
    info <- switch(place,
      ...
      id = "Something went wrong when rendering the In-Depth Analysis part.<br/>",
      an = "Something went wrong when rendering the Annotation part.<br/>"
    )
...
if( extractedFiles[["rqc"]] != "empty" ) {
  rqc.qa <- readRDS(file = extractedFiles$rqc)
