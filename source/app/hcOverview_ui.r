      ...
      column(7, 
        box(title = "Find signficant candidates across all methods",width = NULL, solidHeader = FALSE,color = "gray",
          ...
          div(style="display:inline-block; margin-right:10px", 
              checkboxInput("hcOverview_wilcox", "Wilcox", value = TRUE)),
          div(style="display:inline-block; margin-right:10px", 
            checkboxInput("hcOverview_deseq", "DESeq2", value = TRUE)),
          div(style="display:inline-block; margin-right:10px", 
            checkboxInput("hcOverview_mageck", "MAGeCK", value = TRUE)),
          div(style="display:inline-block; margin-right:10px", 
            checkboxInput("hcOverview_rsea", "sgRSEA", value = TRUE)),
          div(style="display:inline-block", checkboxInput("hcOverview_edger", "EdgeR", value = TRUE)),
