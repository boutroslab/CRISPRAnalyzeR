...
tabItem(tabName = "settings", align = "center",
        ...
        fluidRow(
          ...
          column(width = 6, h4("BAGEL"),
                 ...
                 numericInput("bagel_higher", "Highest BAGEL cutoff", value = 100, min = 0, max = 200, step = 1, width = "150px")
                    ...
                    shinyWidgets::awesomeCheckbox("screenbeam_run", value=FALSE, label = HTML("<strong>YES</strong>, activate ScreenBEAM analysis.")),
  ...
  fluidRow(
    ...
    column(width = 8, offset=2,
           ...
           box( title = "Step 4: Removing low/high Read Counts from Analysis",
                ...
                column(width=12,
                       column(width=12,
                              column(width=8, shinyWidgets::awesomeCheckbox("remove_low", value=FALSE, label = HTML("<strong>YES</strong>, remove sgRNAs with a read count <strong>LOWER or equal</strong> to"))),
                              column(width=4, textInput("remove_threshold_low", label = NULL, value="0", placeholder = "Please enter the read count threshold"))
                       ),
                       column(width=12,
                              column(width=8, shinyWidgets::awesomeCheckbox("remove_high", value=FALSE, label = HTML("<strong>YES</strong>, remove sgRNAs with a read count <strong>HIGHER or equal</strong> to"))),
  ...
  fluidRow(style="width:85%",
    ...
    shiny::tags$br(),
    shiny::tags$br(),
    div(actionButton("restartevaluation", "Restart sgRNA Re-Evaluation", icon = icon("refresh"))),
